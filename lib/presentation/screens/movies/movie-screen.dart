...
import 'package:cinemapedia/presentation/providers/movies/movie_info_provder.dart';
...
class MovieScreenState extends ConsumerState<MovieScreen> {
  ...
  void initState() {
    ...
    ref.read(actorByMoviesProvider.notifier).loadActor(widget.movieId);
  }
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverList(
            ...
            return MoviesDetails(movie: movie);
          }, childCount: 1))
        ],
      ),
    );
...
class _ActorsByMovie extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    final actorsByMovies = ref.watch(actorByMoviesProvider);
